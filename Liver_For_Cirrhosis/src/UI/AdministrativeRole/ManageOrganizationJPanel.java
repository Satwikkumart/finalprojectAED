...
import Business.Organization.Organization.CirrhosisCentreType;
import Business.Organization.Organization.GovernmentType;
import Business.Organization.Organization.LegalType;
import Business.Organization.Organization.LiverBankType;
...
import static Business.Enterprise.Enterprise.EnterpriseType.LiverBank;
import static Business.Enterprise.Enterprise.EnterpriseType.CirrhosisCentre;
...
public class ManageOrganizationJPanel extends javax.swing.JPanel {
    ...
    private void populateCombo(){
       ...
       System.out.println(enterprise.getEnterpriseType().toString().equals(LiverBank.toString()));
       ...
       else if(enterprise.getEnterpriseType().toString().equals(LiverBank.toString())){
        for(Organization.LiverBankType liverType: Organization.LiverBankType.values()){
            add = true;
            System.out.println(liverType.getValue());
            System.out.println(Organization.LiverBankType.LiverBank.getValue());
            if (liverType.getValue().equals(Organization.LiverBankType.LiverBank.getValue())){
                for (Organization organization : directory.getOrganizationList()) {
       ...
       else if(enterprise.getEnterpriseType().toString().equals(CirrhosisCentre.toString())){
        for(Organization.CirrhosisCentreType cirrhosisType: Organization.CirrhosisCentreType.values()){
...
// Main Process after validation checks
        ...
        if(enterprise.getEnterpriseType().toString().equals(Legal.toString())){
            ...
            directory.createLiverOrganization((LiverBankType)organizationJComboBox.getSelectedItem(), txtOrgRealName.getText());
        }
        else if(enterprise.getEnterpriseType().toString().equals(CirrhosisCentre.toString())){
            directory.createCirrhosisCentreOrganization((CirrhosisCentreType)organizationJComboBox.getSelectedItem(), txtOrgRealName.getText());
        }
        else{
