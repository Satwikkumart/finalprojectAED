...
public class LiverRequestJPanel extends javax.swing.JPanel {
    ...
    private Liver_Bank_Organization liverorganization;
    private Enterprise enterprise;
    private Network network;
    private DB4OUtil dB4OUtil = DB4OUtil.getInstance();
    private EcoSystem system;
    
    public LiverRequestJPanel(UserAccount userAccount, Liver_Bank_Organization liverBankOrganization, Enterprise enterprise, Network network, EcoSystem system) {
        initComponents();
        this.userAccount = userAccount;
        this.liverorganization = liverBankOrganization;
    ...
    private void initComponents() {
        ...
        tblLiverCoordinator.setFont(new java.awt.Font("Arial", 1, 20)); // NOI18N
        tblLiverCoordinator.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Request Number", "Patient ID", "Patient Name", "Email ID", "DIAG", "Status"
            }
        ) {
        ...
        tblDigAvailability.setFont(new java.awt.Font("Arial", 1, 20)); // NOI18N
    ...
    private void btnApproveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnApproveActionPerformed
        ...
        if (selectedRow < 0){
            ...
            if(request.getStatus().equals("Legally Approved. Passing to LiverBank")
                || request.getStatus().equals("On Hold Due to Liver unavailability")){
                ...
                if (org != null) {
                    request.setStatus("LiverBank Approved. Passing to System Coordinator");
    ...
    private void btnOnHoldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOnHoldActionPerformed
        ...
        if (selectedRow < 0){
            ...
            WorkRequest request = (WorkRequest)tblLiverCoordinator.getValueAt(selectedRow, 0);
            if(request.getStatus().equals("Legally Approved. Passing to LiverBank")){
                request.setStatus("On Hold Due to Liver unavailability");
        ...
        if (selectedRow < 0){   
            ...
            if(request.getStatus().equals("Legally Approved. Passing to LiverBank")){
                ...
                if(request.getPatient().isEmergencyStatus() == true){
                    JOptionPane.showMessageDialog(null, new JLabel("Legally Approved. Passing to LiverBank"), "Warning", JOptionPane.WARNING_MESSAGE);
                }
                //dB4OUtil.storeSystem(system);
...
//                 jPanel1.setVisible(false);
    ...
    private void populateDigAvailabilityTable() {
        ...
        for(Map.Entry<String, Integer> digCount : liverorganization.getInventoryData().entrySet()) {
