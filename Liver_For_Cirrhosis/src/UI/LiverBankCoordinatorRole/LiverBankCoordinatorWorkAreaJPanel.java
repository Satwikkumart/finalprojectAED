...
public class LiverBankCoordinatorWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private Liver_Bank_Organization liverBankOrganization;
    private Enterprise enterprise;
    private EcoSystem system;
    private Network network;
    private DB4OUtil dB4OUtil = DB4OUtil.getInstance();
    
    public LiverBankCoordinatorWorkAreaJPanel(UserAccount account, Liver_Bank_Organization liverBankOrganization, Enterprise enterprise, EcoSystem business, Network network) {
        initComponents();
    ...
    private void BtnProfileMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BtnProfileMouseClicked
        ...
        ManageLiverBankCoordinatorProfile manageliverBankProfile = new ManageLiverBankCoordinatorProfile(userAccount,liverBankOrganization,enterprise);
    ...
    private void BtnManageRequestsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BtnManageRequestsMouseClicked
        // TODO add your handling code here:
        LiverRequestJPanel liverBankRequestJPanel = new LiverRequestJPanel( userAccount,  liverBankOrganization, enterprise, network, system);
