...
//        System.out.println("Inside the non working panel");
    ...
    private void initComponents() {
        ...
        buttonAddLiver.setFont(new java.awt.Font("Arial", 1, 20)); // NOI18N
        buttonAddLiver.setText("Add Organ to Bank");
        ...
        buttonLiverDonated.setFont(new java.awt.Font("Arial", 1, 20)); // NOI18N
        buttonLiverDonated.setText("Organ donated by the donor");
        ...
        buttonLiverDiscard.setFont(new java.awt.Font("Arial", 1, 20)); // NOI18N
        buttonLiverDiscard.setText("Discard the donated organ");
    ...
    private void buttonAddLiverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAddLiverActionPerformed
        ...
        for(Enterprise ent : network.getEnterprise_Directory().getEnterpriseList()){
            ...
            System.out.println(ent.getEnterpriseType().toString());
              if(ent.getEnterpriseType().toString().equals("LiverBank")){
                  ep = ent;           
              }
        }  
        if(ep == null){
            JOptionPane.showMessageDialog(null, new JLabel("<html><b>"
                    + " There is no Liver Bank!"
                    + "</b></html>"), 
                    "Warning", 
        ...
        for (Organization org: ep.getOrganizationDirectory().getOrganizationList()){
              ...
              if(org.getClass().getTypeName().toString().equals("Business.Organization.Liver_Bank_Organization")){
                 org =org;
              }
        }  
        ...
        try {
            org.getAllDIGs().add(PersonDIGType.createDIG(String.valueOf(txtDIGList.getText())));
            PersonDIGType h = new PersonDIGType();
            h.updateDIGlist(txtDIGList.getText());
            ((Liver_Bank_Organization)org).getInventory().DIGCountAdd(h);
          }
        catch( NullPointerException ex   )
          { System.out.println("");
          }
        
                request.setStatus("Liver added to Bank");
                ...
                JOptionPane.showMessageDialog(null, new JLabel(  "<html><b>Marrow added to the bank!</b></html>"));
    ...
    private void buttonLiverDonatedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonLiverDonatedActionPerformed
        ...
        {   JOptionPane.showMessageDialog(null, new JLabel(  "<html><b>Kindly do the Health Check of the Donor before the Marrow Donation</b></html>"), "Warning", JOptionPane.WARNING_MESSAGE);
...
//            }
//        }
                request1.setStatus("Liver Donated");
...
//        populateMedTechDonorTable();
    ...
    private void buttonProcessRequestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonProcessRequestActionPerformed
       ...
       txtDIGList.setText(tblMedTechDonors.getValueAt(selectedRow, 3).toString());
        ...
        else if(request.getStatus().contains("Liver Donated")){
            JOptionPane.showMessageDialog(null, new JLabel(  "<html><b>Sir!!!!<br>Bone Marrow is already Donated</b></html>"), "Warning", JOptionPane.WARNING_MESSAGE);
        }
        else if(request.getStatus().contains("Liver Discarded")) {
            JOptionPane.showMessageDialog(null, new JLabel(  "<html><b>Please check the status!<br>Bone Marrow is already discarded</b></html>"), "Warning", JOptionPane.WARNING_MESSAGE);
        }
        else{
    ...
    private void buttonLiverDiscardActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonLiverDiscardActionPerformed
        ...
        {  
            WorkRequest request = (WorkRequest)tblMedTechDonors.getValueAt(selectedRow, 0);
            request.setStatus("Liver Discarded");
            populateOrganizationDonorTable();
            populateMedTechDonorTable();
            JOptionPane.showMessageDialog(null, new JLabel("<html><b>Bone Marrow Discarded!</b></html>"));  
    ...
    private void tblMedTechDonorsMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblMedTechDonorsMousePressed
        ...
        if(selectedRow >= 0) {
            ...
            if(request.getStatus().equals("Liver Donated")) {
                buttonLiverDonated.setEnabled(false);
                txtDIGList.setEnabled(false);
                buttonAddLiver.setEnabled(true);
                buttonLiverDiscard.setEnabled(true);
